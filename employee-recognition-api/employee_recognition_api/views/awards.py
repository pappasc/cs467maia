...
def test_awards_post_threaded(): 
    ...
    users_exist = check_users_exist(data['authorizing_user_id'], data['receiving_user_id'])
...
# [7] https://stackoverflow.com/questions/26544091/checking-if-type-list-in-python/26544117